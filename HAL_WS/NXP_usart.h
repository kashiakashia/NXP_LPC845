...
void    USART0_Handler (void);                                                  //  odbiór znaku z przerwania
void    USART1_Handler (void);                                                  //  odbiór znaku z przerwania
void    USART2_Handler (void);                                                  //  odbiór znaku z przerwania
void    USART3_Handler (void);                                                  //  odbiór znaku z przerwania
